...
export function getFirstEvenCardPosition(stack) {
  return stack.findIndex(cardIsEven)
}

cardIsEven = card => card % 2 == 0;
cardIsOdd = card => !cardIsEven(card)