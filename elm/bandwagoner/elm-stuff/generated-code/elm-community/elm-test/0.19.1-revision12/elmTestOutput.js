...
var $author$project$Bandwagoner$Coach = F2(
	function (name, formerPlayer) {
		return {formerPlayer: formerPlayer, name: name};
	});
var $author$project$Bandwagoner$Stats = F2(
	function (wins, losses) {
		return {losses: losses, wins: wins};
	});
var $author$project$Bandwagoner$Team = F3(
	function (name, coach, stats) {
		return {coach: coach, name: name, stats: stats};
	});
var $author$project$Bandwagoner$createTeam = F3(
	function (name, stats, coach) {
		return A3($author$project$Bandwagoner$Team, name, coach, stats);
	});
...
var $author$project$Bandwagoner$replaceCoach = F2(
	function (newCoach, team) {
		return _Utils_update(
			team,
			{coach: newCoach});
	});
var $author$project$Bandwagoner$rootForTeam = function (_v0) {
	var stats = _v0.stats;
	return _Utils_cmp(stats.wins, stats.losses) > 0;
};
		...
		[
				...
				[
					...
					function (_v0) {
						return A2(
							...
							{formerPlayer: true, name: 'Steve Kerr'},
							A2($author$project$Bandwagoner$Coach, 'Steve Kerr', true));
					}),
					A2(
					$elm_explorations$test$Test$test,
					'has Stats type alias with correct fields in correct order',
					function (_v1) {
						return A2(
							$elm_explorations$test$Expect$equal,
							{losses: 27, wins: 55},
							A2($author$project$Bandwagoner$Stats, 55, 27));
					}),
					A2(
					$elm_explorations$test$Test$test,
					'has Team type alias with correct fields in correct order',
					function (_v2) {
						var stats = A2($author$project$Bandwagoner$Stats, 58, 22);
						var coach = A2($author$project$Bandwagoner$Coach, 'Red Auerbach', false);
						var team = {coach: coach, name: 'Boston Celtics', stats: stats};
						return A2(
							$elm_explorations$test$Expect$equal,
							team,
							A3($author$project$Bandwagoner$Team, 'Boston Celtics', coach, stats));
					})
				])),
			A2(
			$elm_explorations$test$Test$describe,
			...
			_List_fromArray(
				[
					A2(
					$elm_explorations$test$Test$test,
					'createTeam creates a Team structural type',
					function (_v3) {
						var stats = A2($author$project$Bandwagoner$Stats, 58, 22);
						var coach = A2($author$project$Bandwagoner$Coach, 'Red Auerbach', false);
						var team = A3($author$project$Bandwagoner$createTeam, 'Boston Celtics', stats, coach);
						return A2(
							$elm_explorations$test$Expect$equal,
							team,
							A3($author$project$Bandwagoner$Team, 'Boston Celtics', coach, stats));
			...
			_List_fromArray(
				[
					A2(
					$elm_explorations$test$Test$test,
					'can replace coach for a team',
					function (_v4) {
						var stats = A2($author$project$Bandwagoner$Stats, 6, 8);
						var newCoach = A2($author$project$Bandwagoner$Coach, 'Red Holzman', true);
						var coach = A2($author$project$Bandwagoner$Coach, 'Willis Reed', true);
						var team = A3($author$project$Bandwagoner$Team, 'New York Knicks', coach, stats);
						var newTeam = A2($author$project$Bandwagoner$replaceCoach, newCoach, team);
						return A2(
							$elm_explorations$test$Expect$equal,
							newTeam,
							A3($author$project$Bandwagoner$Team, 'New York Knicks', newCoach, stats));
					})
				])),
			A2(
			$elm_explorations$test$Test$describe,
			...
			_List_fromArray(
				[
					A2(
					$elm_explorations$test$Test$test,
					'should root for teams that have more wins than losses',
					function (_v5) {
						return A2(
							$elm_explorations$test$Expect$equal,
							true,
							$author$project$Bandwagoner$rootForTeam(
								A3(
									$author$project$Bandwagoner$Team,
									'',
									A2($author$project$Bandwagoner$Coach, '', true),
									A2($author$project$Bandwagoner$Stats, 1, 0))));
					}),
					A2(
					$elm_explorations$test$Test$test,
					'should not root for teams that lose more than they win',
					function (_v6) {
						return A2(
							$elm_explorations$test$Expect$equal,
							false,
							$author$project$Bandwagoner$rootForTeam(
								A3(
									...
									'',
									A2($author$project$Bandwagoner$Coach, '', true),
									A2($author$project$Bandwagoner$Stats, 43, 44))));
					}),
					A2(
					$elm_explorations$test$Test$test,
					'should not root for teams that have equal losses and wins',
					function (_v7) {
						return A2(
							$elm_explorations$test$Expect$equal,
							false,
							$author$project$Bandwagoner$rootForTeam(
								A3(
									...
									'',
									A2($author$project$Bandwagoner$Coach, '', true),
									A2($author$project$Bandwagoner$Stats, 143, 143))));
					}),
					A2(
					$elm_explorations$test$Test$test,
					'should root for extended teams that have more wins than losses',
					function (_v8) {
						return A2(
							$elm_explorations$test$Expect$equal,
							true,
							$author$project$Bandwagoner$rootForTeam(
								{
									coach: A2($author$project$Bandwagoner$Coach, '', true),
									name: '',
									someOtherField: '',
									stats: A2($author$project$Bandwagoner$Stats, 1, 0)
								}));
					})
				]))
		]));
var $author$project$Test$Generated$Main$main = A2(
	$author$project$Test$Runner$Node$run,
	{
		...
		paths: _List_fromArray(
			['/home/oezg/code/exercism/elm/bandwagoner/tests/Tests.elm']),
		processes: 4,
		report: $author$project$Test$Reporter$Reporter$ConsoleReport($author$project$Console$Text$UseColor),
		runs: 100,
		seed: 390417716691239
	},
	_List_fromArray(
		[
			_Utils_Tuple2(
...
var pipeFilename = "/tmp/elm_test-21948.sock";
var net = require('net'),
