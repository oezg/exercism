...
```sh
ros run --load key-comparison-test.lisp --eval '(uiop:quit (if (key-comparison-test:run-tests) 0 1))'
```

## Submitting your solution

You can submit your solution using the `exercism submit key-comparison.lisp` command.
