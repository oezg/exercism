...
var $author$project$MariosMarvellousLasagna$remainingTimeInMinutes = F2(
	function (layers, minutes) {
		var preparationTimeInMinutes = function (numberOfLayers) {
			return 2 * numberOfLayers;
		};
		var expectedMinutesInOven = 40;
		return (preparationTimeInMinutes(layers) + expectedMinutesInOven) - minutes;
	});
...
var $author$project$Test$Generated$Main$main = A2(
	$author$project$Test$Runner$Node$run,
	{
		...
		paths: _List_fromArray(
			['/home/oezg/code/exercism/elm/marios-marvellous-lasagna/tests/Tests.elm']),
		processes: 4,
		report: $author$project$Test$Reporter$Reporter$ConsoleReport($author$project$Console$Text$UseColor),
		runs: 100,
		seed: 172577264174315
	},
	_List_fromArray(
		[
			_Utils_Tuple2(
...
var pipeFilename = "/tmp/elm_test-23287.sock";
var net = require('net'),
