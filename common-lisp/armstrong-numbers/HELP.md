...
```sh
ros run --load armstrong-numbers-test.lisp --eval '(uiop:quit (if (armstrong-numbers-test:run-tests) 0 1))'
```

## Submitting your solution

You can submit your solution using the `exercism submit armstrong-numbers.lisp` command.
