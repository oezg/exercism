...
public class BobTest {
  ...
  @Test
  @DisplayName("Non ANSI uppercase letters")
  public void nonAnsiUppercaseLetters() {
    assertThat(bob.hey("ÄĞ ĞŞŞÜİÇÖÇÖ")).isEqualTo("Whoa, chill out!");
  }

  @Test
  @DisplayName("Non ANSI lowercase letters")
  public void nonAnsiLowercaseLetters() {
    assertThat(bob.hey("ğüşiöççö,äßıııııı\nıııüüüöööççç?")).isEqualTo("Sure.");
  }
}
