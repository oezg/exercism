...
var $author$project$RolePlayingGame$castSpell = F2(
	function (manaCost, player) {
		var _v0 = player.mana;
		if (_v0.$ === 'Nothing') {
			return _Utils_Tuple2(
				_Utils_update(
					player,
					{
						health: A2($elm$core$Basics$max, 0, player.health - manaCost)
					}),
				0);
		} else {
			var manaValue = _v0.a;
			return (_Utils_cmp(manaValue, manaCost) < 0) ? _Utils_Tuple2(player, 0) : _Utils_Tuple2(
				_Utils_update(
					player,
					{
						mana: $elm$core$Maybe$Just(manaValue - manaCost)
					}),
				manaCost * 2);
		}
	});
...
var $author$project$RolePlayingGame$introduce = function (_v0) {
	var name = _v0.name;
	return A2($elm$core$Maybe$withDefault, 'Mighty Magician', name);
};
var $author$project$RolePlayingGame$revive = function (player) {
	var levelBelowTen = player.level < 10;
	var alivePlayer = player.health > 0;
	return alivePlayer ? $elm$core$Maybe$Nothing : (levelBelowTen ? $elm$core$Maybe$Just(
		_Utils_update(
			player,
			{health: 100, mana: $elm$core$Maybe$Nothing})) : $elm$core$Maybe$Just(
		_Utils_update(
			player,
			{
				health: 100,
				mana: $elm$core$Maybe$Just(100)
			})));
};
		...
		[
			...
			_List_fromArray(
				[
					...
					'Introducing someone with their name',
					function (_v0) {
						return A2(
							$elm_explorations$test$Expect$equal,
							$author$project$RolePlayingGame$introduce(
								{
									health: 42,
									level: 1,
									mana: $elm$core$Maybe$Nothing,
									name: $elm$core$Maybe$Just('Gandalf')
								}),
							'Gandalf');
					}),
					A2(
					$elm_explorations$test$Test$test,
					'Introducing an unidentified player should return \'Mighty Magician\'',
					function (_v1) {
						return A2(
							$elm_explorations$test$Expect$equal,
							$author$project$RolePlayingGame$introduce(
								{health: 42, level: 1, mana: $elm$core$Maybe$Nothing, name: $elm$core$Maybe$Nothing}),
							'Mighty Magician');
					})
				])),
			A2(
			...
			_List_fromArray(
				[
					A2(
					$elm_explorations$test$Test$test,
					'Attempting to revive a player that is alive should return Nothing',
					function (_v2) {
						return A2(
							$elm_explorations$test$Expect$equal,
							$author$project$RolePlayingGame$revive(
								{
									health: 42,
									level: 12,
									mana: $elm$core$Maybe$Just(7),
					...
					A2(
					$elm_explorations$test$Test$test,
					'Reviving a low level player resets its health to 100',
					function (_v3) {
						return A2(
							$elm_explorations$test$Expect$equal,
							$author$project$RolePlayingGame$revive(
								{health: 0, level: 3, mana: $elm$core$Maybe$Nothing, name: $elm$core$Maybe$Nothing}),
							$elm$core$Maybe$Just(
								{health: 100, level: 3, mana: $elm$core$Maybe$Nothing, name: $elm$core$Maybe$Nothing}));
					}),
					A2(
					$elm_explorations$test$Test$test,
					'Reviving a high level player resets both its health and mana',
					function (_v4) {
						return A2(
							$elm_explorations$test$Expect$equal,
							$author$project$RolePlayingGame$revive(
			...
			_List_fromArray(
				[
					A2(
					$elm_explorations$test$Test$test,
					'Casting a spell causes damage of double the mana',
					function (_v5) {
						return A2(
							$elm_explorations$test$Expect$equal,
							A2(
								$author$project$RolePlayingGame$castSpell,
								9,
								{
									health: 69,
									level: 10,
									mana: $elm$core$Maybe$Just(20),
									name: $elm$core$Maybe$Nothing
								}),
							_Utils_Tuple2(
								{
					...
					A2(
					$elm_explorations$test$Test$test,
					'Attempting to cast a spell with insufficient mana does nothing',
					function (_v6) {
						return A2(
							$elm_explorations$test$Expect$equal,
							A2(
					...
					A2(
					$elm_explorations$test$Test$test,
					'Attempting to cast a spell without a mana pool decreases the player\'s health',
					function (_v7) {
						return A2(
							$elm_explorations$test$Expect$equal,
							A2(
								$author$project$RolePlayingGame$castSpell,
								7,
								{health: 58, level: 5, mana: $elm$core$Maybe$Nothing, name: $elm$core$Maybe$Nothing}),
							_Utils_Tuple2(
								{health: 51, level: 5, mana: $elm$core$Maybe$Nothing, name: $elm$core$Maybe$Nothing},
								0));
					}),
					A2(
					$elm_explorations$test$Test$test,
					'A player\'s health cannot go below 0',
					function (_v8) {
						return A2(
							$elm_explorations$test$Expect$equal,
							A2(
								$author$project$RolePlayingGame$castSpell,
								12,
								{health: 6, level: 5, mana: $elm$core$Maybe$Nothing, name: $elm$core$Maybe$Nothing}),
							_Utils_Tuple2(
								{health: 0, level: 5, mana: $elm$core$Maybe$Nothing, name: $elm$core$Maybe$Nothing},
								0));
					})
				]))
		]));
var $author$project$Test$Generated$Main$main = A2(
	$author$project$Test$Runner$Node$run,
	{
		...
		paths: _List_fromArray(
			['/home/oezg/code/exercism/elm/role-playing-game/tests/Tests.elm']),
		processes: 4,
		report: $author$project$Test$Reporter$Reporter$ConsoleReport($author$project$Console$Text$UseColor),
		runs: 100,
		seed: 345599945672069
	},
	_List_fromArray(
		[
			_Utils_Tuple2(
...
var pipeFilename = "/tmp/elm_test-25228.sock";
var net = require('net'),
