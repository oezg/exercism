...
var $author$project$MagicianInTraining$addCard = $elm$core$Array$push;
...
var $author$project$MagicianInTraining$isEven = function (n) {
	return !A2($elm$core$Basics$modBy, 2, n);
};
var $author$project$MagicianInTraining$evenCardCount = A2(
	$elm$core$Basics$composeR,
	$elm$core$Array$filter($author$project$MagicianInTraining$isEven),
	$elm$core$Array$length);
var $author$project$MagicianInTraining$getCard = $elm$core$Array$get;
...
var $author$project$MagicianInTraining$removeCard = F2(
	function (index, deck) {
		var cardsBefore = A3($elm$core$Array$slice, 0, index, deck);
		var cardsAfter = A3(
			$elm$core$Array$slice,
			index + 1,
			$elm$core$Array$length(deck),
			deck);
		return A2($elm$core$Array$append, cardsBefore, cardsAfter);
	});
var $author$project$MagicianInTraining$setCard = $elm$core$Array$set;
		...
		[
			...
			_List_fromArray(
				[
					...
					'getCard should return the card at index',
					function (_v0) {
						return A2(
							$elm_explorations$test$Expect$equal,
							$elm$core$Maybe$Just(4),
							A2(
								$author$project$MagicianInTraining$getCard,
								2,
			...
			_List_fromArray(
				[
					A2(
					$elm_explorations$test$Test$test,
					'setCard should change the card at index',
					function (_v1) {
						return A2(
							$elm_explorations$test$Expect$equal,
							$elm$core$Array$fromList(
								_List_fromArray(
									[1, 2, 6])),
							A3(
								$author$project$MagicianInTraining$setCard,
								2,
								6,
								$elm$core$Array$fromList(
									_List_fromArray(
					...
					A2(
					$elm_explorations$test$Test$test,
					'setCard should do nothing if the index is out of bounds',
					function (_v2) {
						return A2(
							$elm_explorations$test$Expect$equal,
							$elm$core$Array$fromList(
						...
						return A2(
							...
							$elm$core$Array$fromList(
								_List_fromArray(
									[5, 9, 7, 1, 8])),
							A2(
								$author$project$MagicianInTraining$addCard,
								8,
								$elm$core$Array$fromList(
									_List_fromArray(
										[5, 9, 7, 1]))));
			...
			_List_fromArray(
				[
					A2(
					$elm_explorations$test$Test$test,
					'removeCard should remove the card at index',
					function (_v4) {
						return A2(
							$elm_explorations$test$Expect$equal,
							$elm$core$Array$fromList(
								_List_fromArray(
									[3, 2, 4, 8])),
							A2(
								$author$project$MagicianInTraining$removeCard,
								2,
								$elm$core$Array$fromList(
									_List_fromArray(
										[3, 2, 6, 4, 8]))));
					...
					A2(
					$elm_explorations$test$Test$test,
					'removeCard should do nothing if the index is out of bounds',
					function (_v5) {
						return A2(
							$elm_explorations$test$Expect$equal,
							$elm$core$Array$fromList(
			...
			_List_fromArray(
				[
					A2(
					$elm_explorations$test$Test$test,
					'evenCardCount returns the number of even cards in the deck',
					function (_v6) {
						return A2(
							$elm_explorations$test$Expect$equal,
							4,
							$author$project$MagicianInTraining$evenCardCount(
								$elm$core$Array$fromList(
									_List_fromArray(
										[3, 8, 4, 5, 1, 6, 10]))));
					})
...
var $author$project$Test$Generated$Main$main = A2(
	$author$project$Test$Runner$Node$run,
	{
		...
		paths: _List_fromArray(
			['/home/oezg/code/exercism/elm/magician-in-training/tests/Tests.elm']),
		processes: 4,
		report: $author$project$Test$Reporter$Reporter$ConsoleReport($author$project$Console$Text$UseColor),
		runs: 100,
		seed: 151127695348891
	},
	_List_fromArray(
		[
			_Utils_Tuple2(
...
var pipeFilename = "/tmp/elm_test-15288.sock";
var net = require('net'),
