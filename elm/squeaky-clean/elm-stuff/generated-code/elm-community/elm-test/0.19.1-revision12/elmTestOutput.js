...
var $author$project$SqueakyClean$clean1 = A2($elm$core$String$replace, ' ', '_');
var $author$project$SqueakyClean$controlToLabel = F2(
	function (acc, str) {
		controlToLabel:
		while (true) {
			if (!acc.b) {
				...
				var tail = acc.b;
				var $temp$acc = tail,
					$temp$str = A3($elm$core$String$replace, head, '[CTRL]', str);
				acc = $temp$acc;
				str = $temp$str;
				continue controlToLabel;
			}
		}
	});
var $author$project$SqueakyClean$clean2 = A2(
	$elm$core$Basics$composeR,
	$author$project$SqueakyClean$clean1,
	$author$project$SqueakyClean$controlToLabel(
		_List_fromArray(
			['\n', '\u000D', '\t'])));
...
var $author$project$SqueakyClean$clean3 = function () {
	var submatch = function (m) {
		return A2(
			$elm$core$Maybe$withDefault,
			'',
			A2(
	...
	return A2($elm$core$Basics$composeR, $author$project$SqueakyClean$clean2, kabapCase);
}();
var $elm$core$String$filter = _String_filter;
var $author$project$SqueakyClean$clean4 = A2(
	$elm$core$Basics$composeR,
	$author$project$SqueakyClean$clean3,
	$elm$core$String$filter(
		A2($elm$core$Basics$composeR, $elm$core$Char$isDigit, $elm$core$Basics$not)));
var $author$project$SqueakyClean$clean = A2(
	$elm$core$Basics$composeR,
	$author$project$SqueakyClean$clean4,
	$elm$core$String$filter(
		function (chr) {
			return (_Utils_cmp(
				chr,
				_Utils_chr('α')) < 0) || (_Utils_cmp(
				chr,
				_Utils_chr('ω')) > 0);
		}));
				...
				[
					...
					function (_v1) {
						return A2(
							$elm_explorations$test$Expect$equal,
							'A',
							$author$project$SqueakyClean$clean1('A'));
					}),
					A2(
					$elm_explorations$test$Test$test,
					'Keep any unicode character',
					function (_v2) {
						return A2(
							$elm_explorations$test$Expect$equal,
							'àḃç',
							$author$project$SqueakyClean$clean1('àḃç'));
					}),
					A2(
					$elm_explorations$test$Test$test,
					...
					function (_v3) {
						return A2(
							$elm_explorations$test$Expect$equal,
							'my___Id',
							$author$project$SqueakyClean$clean1('my   Id'));
					})
				])),
			A2(
			$elm_explorations$test$Test$describe,
				...
				[
					...
					function (_v4) {
						return A2(
							$elm_explorations$test$Expect$equal,
							'',
							$author$project$SqueakyClean$clean2(''));
					}),
					A2(
					$elm_explorations$test$Test$test,
					'Keep single character',
					function (_v5) {
						return A2(
							$elm_explorations$test$Expect$equal,
							'A',
							$author$project$SqueakyClean$clean2('A'));
					}),
					A2(
					$elm_explorations$test$Test$test,
					'Keep any unicode character',
					function (_v6) {
						return A2(
							$elm_explorations$test$Expect$equal,
							'àḃç',
							$author$project$SqueakyClean$clean2('àḃç'));
					}),
					A2(
					$elm_explorations$test$Test$test,
					'replace white space with underscores',
					function (_v7) {
						return A2(
							$elm_explorations$test$Expect$equal,
							'my___Id',
							$author$project$SqueakyClean$clean2('my   Id'));
					}),
					A2(
					$elm_explorations$test$Test$test,
					...
					function (_v9) {
						return A2(
							$elm_explorations$test$Expect$equal,
							'Line_one.[CTRL]Line_two.[CTRL]',
							$author$project$SqueakyClean$clean2('Line one.\u000DLine two.\u000D'));
					})
				])),
			A2(
			$elm_explorations$test$Test$describe,
				...
				[
					...
					function (_v11) {
						return A2(
							$elm_explorations$test$Expect$equal,
							'A',
							$author$project$SqueakyClean$clean3('A'));
					}),
					A2(
					$elm_explorations$test$Test$test,
					'Keep any unicode character',
					function (_v12) {
						return A2(
							$elm_explorations$test$Expect$equal,
							'àḃç',
							$author$project$SqueakyClean$clean3('àḃç'));
					}),
					A2(
					$elm_explorations$test$Test$test,
					'replace white space with underscores',
					function (_v13) {
						return A2(
							$elm_explorations$test$Expect$equal,
							'my___Id',
							$author$project$SqueakyClean$clean3('my   Id'));
					}),
					A2(
					$elm_explorations$test$Test$test,
					'Replace control characters with \'[CTRL]\'',
					...
					function (_v15) {
						return A2(
							$elm_explorations$test$Expect$equal,
							'Line_one.[CTRL]Line_two.[CTRL]',
							$author$project$SqueakyClean$clean3('Line one.\u000DLine two.\u000D'));
					}),
					A2(
					$elm_explorations$test$Test$test,
					...
					function (_v16) {
						return A2(
							$elm_explorations$test$Expect$equal,
							'àḂç',
							$author$project$SqueakyClean$clean3('à-ḃç'));
					})
				])),
			A2(
			$elm_explorations$test$Test$describe,
				...
				[
					...
					function (_v18) {
						return A2(
							$elm_explorations$test$Expect$equal,
							'A',
							$author$project$SqueakyClean$clean4('A'));
					}),
					A2(
					$elm_explorations$test$Test$test,
					'Keep any unicode character',
					function (_v19) {
						return A2(
							$elm_explorations$test$Expect$equal,
							'àḃç',
							$author$project$SqueakyClean$clean4('àḃç'));
					}),
					A2(
					$elm_explorations$test$Test$test,
					'replace white space with underscores',
					function (_v20) {
						return A2(
							$elm_explorations$test$Expect$equal,
							'my___Id',
							$author$project$SqueakyClean$clean4('my   Id'));
					}),
					A2(
					$elm_explorations$test$Test$test,
					'Replace control characters with \'[CTRL]\'',
					...
					function (_v22) {
						return A2(
							$elm_explorations$test$Expect$equal,
							'Line_one.[CTRL]Line_two.[CTRL]',
							$author$project$SqueakyClean$clean4('Line one.\u000DLine two.\u000D'));
					}),
					A2(
					$elm_explorations$test$Test$test,
					'kebab-case to camelCase',
					function (_v23) {
						return A2(
							$elm_explorations$test$Expect$equal,
							'àḂç',
							$author$project$SqueakyClean$clean4('à-ḃç'));
					}),
					A2(
					$elm_explorations$test$Test$test,
					'Omit digits',
					function (_v24) {
						return A2(
							$elm_explorations$test$Expect$equal,
							'MyFinder',
							$author$project$SqueakyClean$clean4('1My2Finder3'));
					})
				])),
			A2(
			$elm_explorations$test$Test$describe,
				...
				[
					...
					function (_v25) {
						return A2(
							$elm_explorations$test$Expect$equal,
							'',
							$author$project$SqueakyClean$clean(''));
					}),
					A2(
					$elm_explorations$test$Test$test,
					'Keep single character',
					function (_v26) {
						return A2(
							$elm_explorations$test$Expect$equal,
							'A',
							$author$project$SqueakyClean$clean('A'));
					}),
					A2(
					$elm_explorations$test$Test$test,
					'Keep any unicode character',
					function (_v27) {
						return A2(
							$elm_explorations$test$Expect$equal,
							'àḃç',
							$author$project$SqueakyClean$clean('àḃç'));
					}),
					A2(
					$elm_explorations$test$Test$test,
					'replace white space with underscores',
					function (_v28) {
						return A2(
							$elm_explorations$test$Expect$equal,
							'my___Id',
							$author$project$SqueakyClean$clean('my   Id'));
					}),
					A2(
					$elm_explorations$test$Test$test,
					'Replace control characters with \'[CTRL]\'',
					...
					function (_v30) {
						return A2(
							$elm_explorations$test$Expect$equal,
							'Line_one.[CTRL]Line_two.[CTRL]',
							$author$project$SqueakyClean$clean('Line one.\u000DLine two.\u000D'));
					}),
					A2(
					$elm_explorations$test$Test$test,
					'kebab-case to camelCase',
					function (_v31) {
						return A2(
							$elm_explorations$test$Expect$equal,
							'àḂç',
							$author$project$SqueakyClean$clean('à-ḃç'));
					}),
					A2(
					$elm_explorations$test$Test$test,
					'Omit digits',
					function (_v32) {
						return A2(
							$elm_explorations$test$Expect$equal,
							'MyFinder',
							$author$project$SqueakyClean$clean('1My2Finder3'));
					}),
					A2(
					$elm_explorations$test$Test$test,
					...
					function (_v33) {
						return A2(
							$elm_explorations$test$Expect$equal,
							'My_Ο_Finder',
							$author$project$SqueakyClean$clean('My Οβιεγτ Finder'));
					}),
					A2(
					$elm_explorations$test$Test$test,
					...
					function (_v34) {
						return A2(
							$elm_explorations$test$Expect$equal,
							'_AbcĐ[CTRL]',
							$author$project$SqueakyClean$clean('9 -abcĐ0ω\u000D'));
					})
				]))
		]));
var $author$project$Test$Generated$Main$main = A2(
	$author$project$Test$Runner$Node$run,
	{
		...
		paths: _List_fromArray(
			['/home/oezg/code/exercism/elm/squeaky-clean/tests/Tests.elm']),
		processes: 4,
		report: $author$project$Test$Reporter$Reporter$ConsoleReport($author$project$Console$Text$UseColor),
		runs: 100,
		seed: 142220812994743
	},
	_List_fromArray(
		[
			_Utils_Tuple2(
...
var pipeFilename = "/tmp/elm_test-29727.sock";
var net = require('net'),
